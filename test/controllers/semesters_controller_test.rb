...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post semesters_url, params: { semester: { end: @semester.end, name: @semester.name, start: @semester.start } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { end: @semester.end, name: @semester.name, start: @semester.start } }
